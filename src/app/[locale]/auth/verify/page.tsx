...
export default function VerifyMagicLinkPage() {
  ...
  const verifyToken = async (token: string) => {
    try {
      ...
      localStorage.setItem('institutionToken', data.data.sessionToken);
      localStorage.setItem('institutionData', JSON.stringify(data.data.institution));

      setStatus('success');
      setMessage(tVerify('loginSuccessRedirect'));
      ...
      setStatus('error');
      const errorMessage = err instanceof Error ? err.message : tVerify('verificationFailed');
